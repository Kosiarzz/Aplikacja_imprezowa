   ...
   <div class="row col-12 groupList p-0 m-0 mb-4">
      <div class="row col-12 filter-title m-0 p-0 mb-3 pl-2">
         ...
         @csrf
            ...
            <div class="ml-2 mr-2">
               <input id="date" type="date" class="form-control date-filter @error('date') is-invalid @enderror" name="dateFrom">
               @error('date')
            ...
            -
            <div class="ml-2 mr-4">
               <input id="date" type="date" class="form-control date-filter @error('date') is-invalid @enderror" name="dateTo">
               @error('date')
               <span class="invalid-feedback" role="alert">
               <strong>{{ $message }}</strong>
               </span>
            ...
            <div class="row p-0 m-0 mt-3 mb-3">
               ...
               <div class="ml-2 mr-4">
                  <input id="service" type="text" maxlength="100" class="form-control filter-input @error('service') is-invalid @enderror" name="service" placeholder="Typ usługi">
                  @error('service')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
               ...
               <div class="ml-2 mr-4">
                  <input id="business" type="text" maxlength="100" class="form-control filter-input @error('business') is-invalid @enderror" name="business" placeholder="Nazwa firmy">
                  @error('business')
                     <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                     </span>
