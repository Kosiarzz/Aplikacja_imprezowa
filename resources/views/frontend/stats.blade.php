...
@section('content')
<div style="width:100%; height:95vh; background:#0763b0; color:#0763b0; font-size:24px;">
    <div class="row justify-content-center">
        <div class="mt-5 pt-5" style="color:#fff; font-size:32px; width:100%; text-align:center;">
            Wszystko czego potrzebujesz do zorganizowania wydarzenia w jednym miejscu
        </div>
        <div class="mt-3" style="color:#fff; font-size:20px; width:100%; text-align:center;">
        ...
        <div class="mt-5 mb-5" style="color:#fff; font-size:20px; width:100%; text-align:center;">
